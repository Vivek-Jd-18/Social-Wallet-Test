...
class AlgorandService {
     ...
     * @throws ApiError
     */
    static algorandGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static algorandGenerateAddress(priv) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static algoNodeIndexerGetDriver(xApiKey, indexerPath) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static algoNodeGetDriver(xApiKey, algodPath) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static algoNodePostDriver(xApiKey, algodPath, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/algorand/node/algod/${xApiKey}/${algodPath}`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static algorandGetBalance(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static algorandGetCurrentBlock() {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static algorandGetBlock(roundNumber) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static algorandBlockchainTransfer(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static algorandBlockchainReceiveAsset(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static algorandGetTransaction(txid) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static algorandGetPayTransactionsByFromTo(from, to, limit, next) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static algorandBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
...
//# sourceMappingURL=AlgorandService.js.map