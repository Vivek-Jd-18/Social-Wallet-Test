...
export declare class FlowService {
     ...
     * @throws ApiError
     */
    static flowGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static flowGenerateAddress(xpub: string, index: number): CancelablePromise<{
        /**
         * Flow address
         */
        address?: string;
     ...
     * @throws ApiError
     */
    static flowGeneratePubKey(xpub: string, index: number): CancelablePromise<{
        /**
         * Flow public key
         */
        pubKey?: string;
     ...
     * @throws ApiError
     */
    static flowGeneratePubKeyPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     ...
     * @throws ApiError
     */
    static flowGetBlockChainInfo(): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static flowGetBlock(hash: string): CancelablePromise<FlowBlock>;
    /**
     ...
     * @throws ApiError
     */
    static flowGetBlockEvents(type: string, from: number, to: number): CancelablePromise<Array<FlowEvent>>;
    /**
     ...
     * @throws ApiError
     */
    static flowGetRawTransaction(hash: string): CancelablePromise<FlowTx>;
    /**
     ...
     * @throws ApiError
     */
    static flowGetAccount(address: string): CancelablePromise<FlowAccount>;
    /**
     ...
     * @throws ApiError
     */
    static flowTransferBlockchain(requestBody: (FlowTransactionMnemonic | FlowTransactionPK | FlowTransactionKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static flowTransferCustomBlockchain(requestBody: (FlowCustomTransactionMnemonic | FlowCustomTransactionPK | FlowCustomTransactionKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static flowCreateAddressFromPubKey(requestBody: (FlowCreateAddressFromPubKeyMnemonic | FlowCreateAddressFromPubKeySecret | FlowCreateAddressFromPubKeyKMS)): CancelablePromise<(FlowAddressXpub | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static flowAddPubKeyToAddress(requestBody: (FlowAddPubKeyMnemonic | FlowAddPubKeySecret | FlowAddPubKeySecretKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
}
