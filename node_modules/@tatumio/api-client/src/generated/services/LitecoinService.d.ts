...
export declare class LitecoinService {
    /**
     ...
     * @throws ApiError
     */
    static ltcGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static ltcRpcDriver(requestBody: {
        /**
     ...
     * @throws ApiError
     */
    static ltcGetBlockChainInfo(): CancelablePromise<LtcInfo>;
    /**
     ...
     * @throws ApiError
     */
    static ltcGetBlockHash(i: number): CancelablePromise<{
        /**
         * Block hash
         */
        hash?: string;
     ...
     * @throws ApiError
     */
    static ltcGetBlock(hash: string): CancelablePromise<LtcBlock>;
    /**
     ...
     * @throws ApiError
     */
    static ltcGetRawTransaction(hash: string): CancelablePromise<LtcTx>;
    /**
     ...
     * @throws ApiError
     */
    static ltcGetMempool(): CancelablePromise<Array<string>>;
    /**
     ...
     * @throws ApiError
     */
    static ltcGetTxByAddress(address: string, pageSize: number, offset?: number, txType?: 'incoming' | 'outgoing'): CancelablePromise<Array<LtcTx>>;
    /**
     ...
     * @throws ApiError
     */
    static ltcGetBalanceOfAddress(address: string): CancelablePromise<BtcBasedBalance>;
    /**
     ...
     * @throws ApiError
     */
    static ltcGetBalanceOfAddressBatch(addresses: string): CancelablePromise<Array<BtcBasedBalance>>;
    /**
     ...
     * @throws ApiError
     */
    static ltcGetUtxo(hash: string, index: number): CancelablePromise<LtcUTXO>;
    /**
     ...
     * @throws ApiError
     */
    static ltcGenerateAddress(xpub: string, index: number): CancelablePromise<{
        /**
         * Litecoin address
         */
        address?: string;
     ...
     * @throws ApiError
     */
    static ltcGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     ...
     * @throws ApiError
     */
    static ltcTransferBlockchain(requestBody: (LtcTransactionAddress | LtcTransactionAddressKMS | LtcTransactionUTXO | LtcTransactionUTXOKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static ltcBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
