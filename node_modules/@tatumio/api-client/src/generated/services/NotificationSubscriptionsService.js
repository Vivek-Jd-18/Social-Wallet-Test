...
exports.NotificationSubscriptionsService = void 0;
...
class NotificationSubscriptionsService {
                                                             ...
                                                             * {
                                                                 ...
                                                                 * <pre>{
                                                                     ...
                                                                     * <pre>{
                                                                         ...
                                                                         * @throws ApiError
                                                                         */
    static createSubscription(requestBody, testnetType = 'ethereum-sepolia') {
     ...
     * @throws ApiError
     */
    static getSubscriptions(pageSize, offset, address) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/subscription`,
            query: {
     ...
     * @throws ApiError
     */
    static enableWebHookHmac(requestBody) {
        return (0, request_1.request)({
            method: 'PUT',
            path: `/v3/subscription`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static getSubscriptionsCount(pageSize, offset, address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static getSubscriptionReport(id) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static getAllWebhooks(pageSize, offset, direction, failed) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static getAllWebhooksCount(pageSize, offset, direction, failed) {
        return (0, request_1.request)({
            method: 'GET',
...
exports.NotificationSubscriptionsService = NotificationSubscriptionsService;
//# sourceMappingURL=NotificationSubscriptionsService.js.map