...
export declare class PolygonService {
     ...
     * @throws ApiError
     */
    static polygonGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static polygonGenerateAddress(xpub: string, index: number): CancelablePromise<GeneratedAddressMatic>;
    /**
     ...
     * @throws ApiError
     */
    static polygonGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static polygonWeb3Driver(xApiKey: string, requestBody: any): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static polygonGetCurrentBlock(): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static polygonGetBlock(hash: string): CancelablePromise<EthBlock>;
    /**
     ...
     * @throws ApiError
     */
    static polygonGetBalance(address: string): CancelablePromise<MaticBalance>;
    /**
     ...
     * @throws ApiError
     */
    static polygonGetTransaction(hash: string): CancelablePromise<PolygonTx>;
    /**
     ...
     * @throws ApiError
     */
    static polygonGetTransactionByAddress(address: string, pageSize: number, offset?: number, from?: number, to?: number, sort?: 'ASC' | 'DESC'): CancelablePromise<Array<PolygonTx>>;
    /**
     ...
     * @throws ApiError
     */
    static polygonGetTransactionCount(address: string): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static polygonBlockchainTransfer(requestBody: (TransferPolygonBlockchain | TransferPolygonBlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static polygonBlockchainSmartContractInvocation(requestBody: (CallPolygonSmartContractReadMethod | CallPolygonSmartContractMethod | CallPolygonSmartContractMethodCaller | CallPolygonSmartContractMethodKMS)): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static polygonBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
