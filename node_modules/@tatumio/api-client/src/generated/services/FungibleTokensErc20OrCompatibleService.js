...
class FungibleTokensErc20OrCompatibleService {
     ...
     * @throws ApiError
     */
    static erc20Deploy(requestBody, xTestnetType = 'ethereum-sepolia') {
     ...
     * @throws ApiError
     */
    static erc20Mint(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static erc20Burn(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static erc20Approve(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static erc20Transfer(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static erc20GetBalance(chain, address, contractAddress, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
