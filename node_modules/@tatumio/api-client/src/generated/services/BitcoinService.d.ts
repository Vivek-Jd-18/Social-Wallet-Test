...
export declare class BitcoinService {
     ...
     * @throws ApiError
     */
    static btcGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static btcGenerateAddress(xpub: string, index: number): CancelablePromise<GeneratedAddressBtc>;
    /**
     ...
     * @throws ApiError
     */
    static btcGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     ...
     * @throws ApiError
     */
    static btcGetBlockChainInfo(): CancelablePromise<BtcInfo>;
    /**
     ...
     * @throws ApiError
     */
    static btcGetBlockHash(i: number): CancelablePromise<BtcBlockHash>;
    /**
     ...
     * @throws ApiError
     */
    static btcGetBlock(hash: string): CancelablePromise<BtcBlock>;
    /**
     ...
     * @throws ApiError
     */
    static btcGetBalanceOfAddress(address: string): CancelablePromise<BtcBasedBalance>;
    /**
     ...
     * @throws ApiError
     */
    static btcGetBalanceOfAddressBatch(addresses: string): CancelablePromise<Array<BtcBasedBalance>>;
    /**
     ...
     * @throws ApiError
     */
    static btcGetTxByAddress(address: string, pageSize: number, offset?: number, txType?: 'incoming' | 'outgoing'): CancelablePromise<Array<BtcTx>>;
    /**
     ...
     * @throws ApiError
     */
    static btcTransferBlockchain(requestBody: (BtcTransactionFromAddress | BtcTransactionFromAddressKMS | BtcTransactionFromUTXO | BtcTransactionFromUTXOKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static btcGetRawTransaction(hash: string): CancelablePromise<BtcTx>;
    /**
     ...
     * @throws ApiError
     */
    static btcGetUtxo(hash: string, index: number): CancelablePromise<BtcUTXO>;
    /**
     ...
     * @throws ApiError
     */
    static btcGetMempool(): CancelablePromise<Array<string>>;
    /**
     ...
     * @throws ApiError
     */
    static btcBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static btcRpcDriver(requestBody: {
        /**
