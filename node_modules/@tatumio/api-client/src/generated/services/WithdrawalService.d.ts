...
export declare class WithdrawalService {
     ...
     * @throws ApiError
     */
    static storeWithdrawal(requestBody: Withdrawal): CancelablePromise<WithdrawalResponse>;
    /**
     * Get withdrawals
     ...
     * @throws ApiError
     */
    static getWithdrawals(pageSize: number, currency?: string, status?: 'InProgress' | 'Done' | 'Cancelled', offset?: number): CancelablePromise<Array<WithdrawalObject>>;
    /**
     * Complete withdrawal
     ...
     * @throws ApiError
     */
    static completeWithdrawal(id: string, txId: string): CancelablePromise<void>;
    /**
     * Cancel withdrawal
     ...
     * @throws ApiError
     */
    static cancelInProgressWithdrawal(id: string, revert?: boolean): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static broadcastBlockchainTransaction(requestBody: BroadcastWithdrawal): CancelablePromise<BroadcastResponse>;
}
