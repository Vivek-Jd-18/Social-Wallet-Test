...
class XinFinService {
     ...
     * @throws ApiError
     */
    static xdcGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static xdcGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static xdcGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static xdcWeb3Driver(xApiKey, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static xdcGetTransactionCount(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static xdcBlockchainTransfer(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static xdcBlockchainSmartContractInvocation(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static xdcBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
...
exports.XinFinService = XinFinService;
//# sourceMappingURL=XinFinService.js.map