...
exports.BlockchainAddressesService = void 0;
const request_1 = require("../core/request");
class BlockchainAddressesService {
    /**
     ...
     * @throws ApiError
     */
    static generateDepositAddress(id, index) {
     ...
     * @throws ApiError
     */
    static getAllDepositAddresses(id) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/offchain/account/${id}/address`,
            errors: {
     ...
     * @throws ApiError
     */
    static generateDepositAddressesBatch(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static addressExists(currency, address, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static assignAddress(id, address, index) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static removeAddress(id, address, index) {
        return (0, request_1.request)({
            method: 'DELETE',
            path: `/v3/offchain/account/${id}/address/${address}`,
            query: {
...
exports.BlockchainAddressesService = BlockchainAddressesService;
//# sourceMappingURL=BlockchainAddressesService.js.map