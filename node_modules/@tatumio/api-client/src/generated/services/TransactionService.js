...
class TransactionService {
     ...
     * @throws ApiError
     */
    static sendTransaction(requestBody) {
     ...
     * @throws ApiError
     */
    static sendTransactionBatch(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static getTransactionsByAccountId(requestBody, pageSize, offset, count) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static getTransactionsByCustomerId(requestBody, pageSize, offset, count) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static getTransactions(requestBody, pageSize, offset, count) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static getTransactionsByReference(reference) {
        return (0, request_1.request)({
            method: 'GET',
