...
exports.NftErc721OrCompatibleService = void 0;
const request_1 = require("../core/request");
class NftErc721OrCompatibleService {
    /**
     ...
     * @throws ApiError
     */
    static nftDeployErc721(requestBody, xTestnetType = 'ethereum-sepolia') {
     ...
     * @throws ApiError
     */
    static nftAddMinter(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * {
         ...
         * {
             ...
             * @throws ApiError
             */
    static nftMintErc721(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/nft/mint`,
            headers: {
     ...
     * @throws ApiError
     */
    static nftTransferErc721(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * <pre>{
         ...
         * @throws ApiError
         */
    static nftMintMultipleErc721(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static nftBurnErc721(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/nft/burn`,
            headers: {
     ...
     * @throws ApiError
     */
    static nftVerifyInCollection(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/nft/verify`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static nftGetTransactionByAddress(chain, address, tokenAddress, pageSize, offset, from, to) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static nftGetTransactionByToken(chain, tokenId, tokenAddress, pageSize, offset, from, to) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static nftGetTransactErc721(chain, hash, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static nftGetTokensByAddressErc721(chain, address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static nftGetBalanceErc721(chain, address, contractAddress, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static nftGetMetadataErc721(chain, contractAddress, tokenId, account, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static nftGetProvenanceDataErc721(chain, contractAddress, tokenId, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static nftGetRoyaltyErc721(chain, contractAddress, tokenId, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static nftUpdateCashbackErc721(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'PUT',
            path: `/v3/nft/royalty`,
            headers: {
     ...
     * @throws ApiError
     */
    static nftGetContractAddress(chain, hash, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
...
exports.NftErc721OrCompatibleService = NftErc721OrCompatibleService;
//# sourceMappingURL=NftErc721OrCompatibleService.js.map