...
exports.BitcoinCashService = void 0;
const request_1 = require("../core/request");
class BitcoinCashService {
    /**
     ...
     * @throws ApiError
     */
    static bchGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static bchGetRawTransaction(hash) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static bchGetTxByAddress(address, skip) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static bchGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static bchGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static bchTransferBlockchain(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static bchBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
...
exports.BitcoinCashService = BitcoinCashService;
//# sourceMappingURL=BitcoinCashService.js.map