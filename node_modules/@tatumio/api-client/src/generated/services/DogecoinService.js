...
class DogecoinService {
     ...
     * @throws ApiError
     */
    static dogeGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static dogeGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static dogeGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static dogeGetRawTransaction(hash) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static dogeGetTxByAddress(address, pageSize, offset, txType) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static dogeGetBalanceOfAddress(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static dogeGetBalanceOfAddressBatch(addresses) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static dogeTransferBlockchain(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static dogeBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
