...
exports.KeyManagementSystemService = void 0;
const request_1 = require("../core/request");
class KeyManagementSystemService {
    /**
     ...
     * @throws ApiError
     */
    static getPendingTransactionsToSign(chain, signatures) {
     ...
     * @throws ApiError
     */
    static receivePendingTransactionsToSign(chain, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/kms/pending/${chain}`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static completePendingSignature(id, txId) {
        return (0, request_1.request)({
            method: 'PUT',
            path: `/v3/kms/${id}/${txId}`,
            errors: {
     ...
     * @throws ApiError
     */
    static getPendingTransactionToSign(id) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/kms/${id}`,
            errors: {
     ...
     * @throws ApiError
     */
    static deletePendingTransactionToSign(id, revert = true) {
        return (0, request_1.request)({
            method: 'DELETE',
            path: `/v3/kms/${id}`,
            query: {
...
exports.KeyManagementSystemService = KeyManagementSystemService;
//# sourceMappingURL=KeyManagementSystemService.js.map