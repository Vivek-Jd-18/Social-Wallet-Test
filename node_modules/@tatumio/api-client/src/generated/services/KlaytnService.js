...
class KlaytnService {
     ...
     * @throws ApiError
     */
    static klaytnGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static klaytnGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static klaytnGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static klaytnWeb3Driver(xApiKey, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static klaytnGetBalance(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static klaytnGetTransaction(hash) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static klaytnGetTransactionCount(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static klaytnBlockchainTransfer(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static klaytnBlockchainSmartContractInvocation(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static klaytnBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
...
exports.KlaytnService = KlaytnService;
//# sourceMappingURL=KlaytnService.js.map