...
class GasPumpService {
     ...
     * [
         ...
         * @throws ApiError
         */
    static precalculateGasPumpAddresses(requestBody) {
     ...
     * @throws ApiError
     */
    static activateGasPumpAddresses(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static activatedNotActivatedGasPumpAddresses(chain, txId) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static gasPumpAddressesActivatedOrNot(chain, owner, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static transferCustodialWallet(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static transferCustodialWalletBatch(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static approveTransferCustodialWallet(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static generateCustodialWalletBatch(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static generateCustodialWallet(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static scGetCustodialAddresses(chain, hash) {
        return (0, request_1.request)({
            method: 'GET',
...
exports.GasPumpService = GasPumpService;
//# sourceMappingURL=GasPumpService.js.map