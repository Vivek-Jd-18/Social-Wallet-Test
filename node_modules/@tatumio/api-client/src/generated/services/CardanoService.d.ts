...
export declare class CardanoService {
     ...
     * @throws ApiError
     */
    static adaGetBlockChainInfo(): CancelablePromise<AdaInfo>;
    /**
     * Generate Ada wallet
     * <p><b>
     ...
     * @throws ApiError
     */
    static adaGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static adaGenerateAddress(xpub: string, index: number): CancelablePromise<{
        /**
         * Ada address
         */
        address?: string;
     ...
     * @throws ApiError
     */
    static adaGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     ...
     * @throws ApiError
     */
    static adaGetBlock(hash: string): CancelablePromise<AdaBlock>;
    /**
     ...
     * @throws ApiError
     */
    static adaGetRawTransaction(hash: string): CancelablePromise<AdaTx>;
    /**
     ...
     * @throws ApiError
     */
    static adaGetTxByAddress(address: string, pageSize: number, offset?: number): CancelablePromise<Array<AdaTx>>;
    /**
     ...
     * @throws ApiError
     */
    static adaGetUtxoByAddress(address: string): CancelablePromise<Array<AdaUTXO>>;
    /**
     ...
     * @throws ApiError
     */
    static adaTransferBlockchain(requestBody: (AdaTransactionFromAddress | AdaTransactionFromAddressKMS | AdaTransactionFromUTXO | AdaTransactionFromUTXOKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static adaBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
    /**
     ...
     * @throws ApiError
     */
    static adaGetAccount(address: string): CancelablePromise<Array<AdaAccountBalance>>;
}
