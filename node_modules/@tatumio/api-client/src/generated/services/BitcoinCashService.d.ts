...
export declare class BitcoinCashService {
    /**
     ...
     * @throws ApiError
     */
    static bchGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static bchRpcDriver(requestBody: {
        /**
     ...
     * @throws ApiError
     */
    static bchGetBlockChainInfo(): CancelablePromise<BchInfo>;
    /**
     ...
     * @throws ApiError
     */
    static bchGetBlockHash(i: number): CancelablePromise<{
        /**
         * Block hash
         */
        hash?: string;
     ...
     * @throws ApiError
     */
    static bchGetBlock(hash: string): CancelablePromise<BchBlock>;
    /**
     ...
     * @throws ApiError
     */
    static bchGetRawTransaction(hash: string): CancelablePromise<BchTx>;
    /**
     ...
     * @throws ApiError
     */
    static bchGetTxByAddress(address: string, skip?: number): CancelablePromise<Array<BchTx>>;
    /**
     ...
     * @throws ApiError
     */
    static bchGenerateAddress(xpub: string, index: number): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static bchGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     ...
     * @throws ApiError
     */
    static bchTransferBlockchain(requestBody: (BchTransaction | BchTransactionKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static bchBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
