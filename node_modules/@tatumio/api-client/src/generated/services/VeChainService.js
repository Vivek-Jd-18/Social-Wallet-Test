...
class VeChainService {
     ...
     * @throws ApiError
     */
    static vetGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static vetGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static vetGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static vetGetTransactionReceipt(hash) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static vetBlockchainTransfer(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static vetBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
...
exports.VeChainService = VeChainService;
//# sourceMappingURL=VeChainService.js.map