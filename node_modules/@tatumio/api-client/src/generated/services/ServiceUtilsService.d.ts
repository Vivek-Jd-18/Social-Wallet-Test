...
export declare class ServiceUtilsService {
    /**
     ...
     * @throws ApiError
     */
    static getCredits(): CancelablePromise<Array<Consumption>>;
    /**
     * Get API version
     ...
     * @throws ApiError
     */
    static getVersion(): CancelablePromise<{
        version?: string;
        status?: string;
        testnet?: boolean;
        planName?: string;
     ...
     * @throws ApiError
     */
    static freezeApiKey(): CancelablePromise<void>;
    /**
     * Unfreeze API Key
     ...
     * @throws ApiError
     */
    static unfreezeApiKey(): CancelablePromise<void>;
}
