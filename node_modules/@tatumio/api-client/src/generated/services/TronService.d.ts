...
export declare class TronService {
     ...
     * @throws ApiError
     */
    static generateTronwallet(mnemonic?: string): CancelablePromise<TronWallet>;
    /**
     ...
     * @throws ApiError
     */
    static tronGenerateAddress(xpub: string, index: number): CancelablePromise<{
        /**
         * Tron address
         */
        address?: string;
     ...
     * @throws ApiError
     */
    static tronGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     ...
     * @throws ApiError
     */
    static tronGetCurrentBlock(): CancelablePromise<{
        /**
         * Block height.
         */
        blockNumber?: number;
     ...
     * @throws ApiError
     */
    static tronGetBlock(hash: string): CancelablePromise<TronBlock>;
    /**
     ...
     * @throws ApiError
     */
    static tronGetAccount(address: string): CancelablePromise<TronAccount>;
    /**
     ...
     * @throws ApiError
     */
    static tronFreeze(requestBody: (FreezeTron | FreezeTronKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    static tronUnfreeze(requestBody: (FreezeTron | FreezeTronKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static tronAccountTx(address: string, next?: string): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static tronAccountTx20(address: string, next?: string): CancelablePromise<{
        /**
         * If present, there are more transactions for the TRON account than the 200 transactions returned in the response, and this parameter specifies the fingerprint of the transaction that follows the last (200<sup>th</sup>) transaction in the returned list of transactions. Use it to get the next 200 transactions for the specified account (for more information, see the description of this API).
         */
        next?: string;
     ...
     * @throws ApiError
     */
    static tronTransfer(requestBody: (TransferTronBlockchain | TransferTronBlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static tronTransferTrc10(requestBody: (TransferTronTrc10Blockchain | TransferTronTrc10BlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static tronTransferTrc20(requestBody: (TransferTronTrc20Blockchain | TransferTronTrc20BlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static tronCreateTrc10(requestBody: (CreateTronTrc10Blockchain | CreateTronTrc10BlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static tronTrc10Detail(idOrOwnerAddress: string): CancelablePromise<TronTrc10Detail>;
    /**
     ...
     * @throws ApiError
     */
    static tronCreateTrc20(requestBody: (CreateTronTrc20Blockchain | CreateTronTrc20BlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static tronGetTransaction(hash: string): CancelablePromise<TronTx>;
    /**
     ...
     * @throws ApiError
     */
    static tronBroadcast(requestBody: TronBroadcast): CancelablePromise<TransactionHash>;
}
