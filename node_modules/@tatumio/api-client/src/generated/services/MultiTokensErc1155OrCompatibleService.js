...
exports.MultiTokensErc1155OrCompatibleService = void 0;
const request_1 = require("../core/request");
class MultiTokensErc1155OrCompatibleService {
    /**
     ...
     * @throws ApiError
     */
    static deployMultiToken(requestBody, xTestnetType = 'ethereum-sepolia') {
     ...
     * @throws ApiError
     */
    static mintMultiToken(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static mintMultiTokenBatch(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static burnMultiToken(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static burnMultiTokenBatch(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static transferMultiToken(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static transferMultiTokenBatch(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static addMultiTokenMinter(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static multiTokenGetTransactionByAddress(chain, address, tokenAddress, pageSize, offset, from, to) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static multiTokenGetTransaction(chain, hash, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static multiTokenGetAddressBalance(chain, address, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static multiTokenGetBalance(chain, address, contractAddress, tokenId, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static multiTokenGetBalanceBatch(chain, contractAddress, tokenId, address, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static multiTokenGetMetadata(chain, token, contractAddress, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static multiTokenGetContractAddress(chain, hash, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
...
exports.MultiTokensErc1155OrCompatibleService = MultiTokensErc1155OrCompatibleService;
//# sourceMappingURL=MultiTokensErc1155OrCompatibleService.js.map