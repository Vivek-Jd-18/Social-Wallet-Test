...
export declare class GasPumpService {
    /**
     ...
     * [
         ...
         * @throws ApiError
         */
    static precalculateGasPumpAddresses(requestBody?: CreateGasPump): CancelablePromise<Array<GasPumpAddress>>;
    /**
     ...
     * @throws ApiError
     */
    static activateGasPumpAddresses(requestBody: (ActivateGasPumpTatum | ActivateGasPump | ActivateGasPumpKMS | ActivateGasPumpCelo | ActivateGasPumpCeloKMS | ActivateGasPumpTron | ActivateGasPumpTronKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static activatedNotActivatedGasPumpAddresses(chain: 'BSC' | 'CELO' | 'ETH' | 'KLAY' | 'MATIC' | 'ONE' | 'TRON', txId: string): CancelablePromise<GasPumpTrxOut>;
    /**
     ...
     * @throws ApiError
     */
    static gasPumpAddressesActivatedOrNot(chain: 'BSC' | 'CELO' | 'ETH' | 'MATIC' | 'KLAY' | 'ONE' | 'TRON', owner: string, index: number): CancelablePromise<Activated>;
    /**
     ...
     * @throws ApiError
     */
    static transferCustodialWallet(requestBody: (TransferCustodialWallet | TransferCustodialWalletKMS | TransferCustodialWalletCelo | TransferCustodialWalletCeloKMS | TransferCustodialWalletTron | TransferCustodialWalletTronKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static transferCustodialWalletBatch(requestBody: (TransferCustodialWalletBatch | TransferCustodialWalletBatchKMS | TransferCustodialWalletBatchCelo | TransferCustodialWalletBatchCeloKMS | TransferCustodialWalletBatchTron | TransferCustodialWalletBatchTronKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static approveTransferCustodialWallet(requestBody: (ApproveTransferCustodialWallet | ApproveTransferCustodialWalletKMS | ApproveTransferCustodialWalletCelo | ApproveTransferCustodialWalletCeloKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static generateCustodialWallet(requestBody: (GenerateCustodialWallet | GenerateCustodialWalletKMS | GenerateCustodialWalletCelo | GenerateCustodialWalletCeloKMS | GenerateCustodialWalletTron | GenerateCustodialWalletTronKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static scGetCustodialAddresses(chain: 'CELO' | 'MATIC' | 'KLAY' | 'ETH' | 'ONE' | 'BSC' | 'TRON', hash: string): CancelablePromise<Array<string>>;
}
