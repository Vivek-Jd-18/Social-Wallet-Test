...
export declare class NodeRpcService {
         ...
         * [
             * {
                 ...
                 * {
                     ...
                     * @throws ApiError
                     */
    static nodeJsonPostRpcDriver(chain: NodeRpcPostChains, requestBody: any, xApiKey?: string, rpcPath?: string): CancelablePromise<any>;
    /**
     * Connect to the blockchain node through an RPC driver
         ...
         * [
             * {
                 ...
                 * {
                     ...
                     * @throws ApiError
                     */
    static nodeJsonRpcPutDriver(chain: NodeRpcPutChains, requestBody: any, xApiKey?: string, rpcPath?: string): CancelablePromise<any>;
    /**
     * Connect to the blockchain node through an RPC driver
     * <p><b>2 credits per RPC method in an API call</b></p>
     * <p>Connect directly to the blockchain node provided by Tatum.</p>
     ...
     * @throws ApiError
     */
    static nodeJsonRpcGetDriver(chain: NodeRpcGetChains, xApiKey?: string, rpcPath?: string): CancelablePromise<any>;
}
