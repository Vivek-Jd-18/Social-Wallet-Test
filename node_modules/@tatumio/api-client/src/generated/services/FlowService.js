...
class FlowService {
     ...
     * @throws ApiError
     */
    static flowGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static flowGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static flowGeneratePubKey(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static flowGeneratePubKeyPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static flowGetBlockEvents(type, from, to) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static flowGetRawTransaction(hash) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static flowTransferBlockchain(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static flowTransferCustomBlockchain(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static flowCreateAddressFromPubKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static flowAddPubKeyToAddress(requestBody) {
        return (0, request_1.request)({
            method: 'PUT',
            path: `/v3/flow/account`,
            body: requestBody,
