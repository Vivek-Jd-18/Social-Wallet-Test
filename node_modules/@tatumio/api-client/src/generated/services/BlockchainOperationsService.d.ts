...
import type { DeployCeloErc20OffchainMnemXpub } from '../models/DeployCeloErc20OffchainMnemXpub';
import type { DeployCeloErc20OffchainPKAddress } from '../models/DeployCeloErc20OffchainPKAddress';
import type { DeployCeloErc20OffchainPKXpub } from '../models/DeployCeloErc20OffchainPKXpub';
import type { DeployErc20OffchainKMSAddress } from '../models/DeployErc20OffchainKMSAddress';
import type { DeployErc20OffchainKMSXpub } from '../models/DeployErc20OffchainKMSXpub';
import type { DeployErc20OffchainMnemonicAddress } from '../models/DeployErc20OffchainMnemonicAddress';
import type { DeployErc20OffchainMnemXpub } from '../models/DeployErc20OffchainMnemXpub';
import type { DeployErc20OffchainPKAddress } from '../models/DeployErc20OffchainPKAddress';
...
import type { DeployTrcOffchainMnemXpub } from '../models/DeployTrcOffchainMnemXpub';
import type { DeployTrcOffchainPKAddress } from '../models/DeployTrcOffchainPKAddress';
import type { DeployTrcOffchainPKXpub } from '../models/DeployTrcOffchainPKXpub';
import type { Erc20 } from '../models/Erc20';
import type { Erc20Address } from '../models/Erc20Address';
...
import type { TransferBchMnemonic } from '../models/TransferBchMnemonic';
import type { TransferBnb } from '../models/TransferBnb';
import type { TransferBnbKMS } from '../models/TransferBnbKMS';
import type { TransferBsc } from '../models/TransferBsc';
import type { TransferBscKMS } from '../models/TransferBscKMS';
import type { TransferBscMnemonic } from '../models/TransferBscMnemonic';
import type { TransferBtcKeyPair } from '../models/TransferBtcKeyPair';
import type { TransferBtcKMS } from '../models/TransferBtcKMS';
import type { TransferBtcMnemonic } from '../models/TransferBtcMnemonic';
import type { TransferCelo } from '../models/TransferCelo';
import type { TransferCeloKMS } from '../models/TransferCeloKMS';
import type { TransferCeloMnemonic } from '../models/TransferCeloMnemonic';
import type { TransferDogeKeyPair } from '../models/TransferDogeKeyPair';
import type { TransferDogeKMS } from '../models/TransferDogeKMS';
import type { TransferDogeMnemonic } from '../models/TransferDogeMnemonic';
import type { TransferErc20 } from '../models/TransferErc20';
import type { TransferErc20KMS } from '../models/TransferErc20KMS';
import type { TransferErc20Mnemonic } from '../models/TransferErc20Mnemonic';
import type { TransferEth } from '../models/TransferEth';
import type { TransferEthKMS } from '../models/TransferEthKMS';
import type { TransferEthMnemonic } from '../models/TransferEthMnemonic';
...
import type { TransferXlm } from '../models/TransferXlm';
...
export declare class BlockchainOperationsService {
    /**
     ...
     * @throws ApiError
     */
    static btcTransfer(requestBody: (TransferBtcMnemonic | TransferBtcKeyPair | TransferBtcKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static bchTransfer(requestBody: (TransferBchMnemonic | TransferBchKeyPair | TransferBchKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static ltcTransfer(requestBody: (TransferLtcMnemonic | TransferLtcKeyPair | TransferLtcKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static flowTransfer(requestBody: (TransferFlowMnemonic | TransferFlowPK | TransferFlowKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static dogeTransfer(requestBody: (TransferDogeMnemonic | TransferDogeKeyPair | TransferDogeKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static ethTransfer(requestBody: (TransferEth | TransferEthMnemonic | TransferEthKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static polygonTransfer(requestBody: (TransferEth | TransferEthMnemonic | TransferEthKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static kcsTransfer(requestBody: (TransferKCS | TransferKCSMnemonic | TransferKCSKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static ethTransferErc20(requestBody: (TransferErc20 | TransferErc20Mnemonic | TransferErc20KMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static createErc20(requestBody: (Erc20 | Erc20Address)): CancelablePromise<Erc20Response>;
    /**
     ...
     * @throws ApiError
     */
    static ethDeployErc20(requestBody: (DeployErc20OffchainMnemonicAddress | DeployErc20OffchainMnemXpub | DeployErc20OffchainPKAddress | DeployErc20OffchainPKXpub | DeployErc20OffchainKMSAddress | DeployErc20OffchainKMSXpub)): CancelablePromise<(DeployErc20Response | DeployErc20SignatureResponse)>;
    /**
     ...
     * @throws ApiError
     */
    static bscOrBepTransfer(requestBody: (TransferBsc | TransferBscMnemonic | TransferBscKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static createBep20(requestBody: (Erc20 | Erc20Address)): CancelablePromise<Erc20Response>;
    /**
     ...
     * @throws ApiError
     */
    static bscDeployBep20(requestBody: (DeployErc20OffchainMnemonicAddress | DeployErc20OffchainMnemXpub | DeployErc20OffchainPKAddress | DeployErc20OffchainPKXpub | DeployErc20OffchainKMSAddress | DeployErc20OffchainKMSXpub)): CancelablePromise<(DeployErc20Response | DeployErc20SignatureResponse)>;
    /**
     ...
     * @throws ApiError
     */
    static klayTransfer(requestBody: (TransferEth | TransferEthMnemonic | TransferEthKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static klayDeployErc20(requestBody: (DeployErc20OffchainMnemonicAddress | DeployErc20OffchainMnemXpub | DeployErc20OffchainPKAddress | DeployErc20OffchainPKXpub | DeployErc20OffchainKMSAddress | DeployErc20OffchainKMSXpub)): CancelablePromise<(DeployErc20Response | DeployErc20SignatureResponse)>;
    /**
     ...
     * @throws ApiError
     */
    static xdcTransfer(requestBody: (TransferEth | TransferEthMnemonic | TransferEthKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static createXdc20(requestBody: (Erc20 | Erc20Address)): CancelablePromise<Erc20Response>;
    /**
     ...
     * @throws ApiError
     */
    static xdcDeployErc20(requestBody: (DeployErc20OffchainMnemonicAddress | DeployErc20OffchainMnemXpub | DeployErc20OffchainPKAddress | DeployErc20OffchainPKXpub | DeployErc20OffchainKMSAddress | DeployErc20OffchainKMSXpub)): CancelablePromise<(DeployErc20Response | DeployErc20SignatureResponse)>;
    /**
     ...
     * @throws ApiError
     */
    static oneTransfer(requestBody: (TransferEth | TransferEthMnemonic | TransferEthKMS), shardId?: number): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static createHrm20(requestBody: (Erc20 | Erc20Address)): CancelablePromise<Erc20Response>;
    /**
     ...
     * @throws ApiError
     */
    static oneDeployHrm20(requestBody: (DeployErc20OffchainMnemonicAddress | DeployErc20OffchainMnemXpub | DeployErc20OffchainPKAddress | DeployErc20OffchainPKXpub | DeployErc20OffchainKMSAddress | DeployErc20OffchainKMSXpub), shardId?: number): CancelablePromise<(DeployErc20Response | DeployErc20SignatureResponse)>;
    /**
     ...
     * @throws ApiError
     */
    static registerErc20Token(chain: 'ETH' | 'CELO' | 'MATIC' | 'KCS' | 'BSC' | 'ONE' | 'XDC' | 'KLAY' | 'SOL', requestBody: (Erc20 | Erc20Address)): CancelablePromise<Erc20Response>;
    /**
     ...
     * @throws ApiError
     */
    static storeTokenAddress(address: string, name: string): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static celoOrErc20Transfer(requestBody: (TransferCelo | TransferCeloMnemonic | TransferCeloKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static createCeloErc20(requestBody: (Erc20 | Erc20Address)): CancelablePromise<Erc20Response>;
    /**
     ...
     * @throws ApiError
     */
    static celoDeployErc20Ledger(requestBody: (DeployCeloErc20OffchainMnemonicAddress | DeployCeloErc20OffchainMnemXpub | DeployCeloErc20OffchainPKAddress | DeployCeloErc20OffchainPKXpub | DeployCeloErc20OffchainKMSAddress | DeployCeloErc20OffchainKMSXpub)): CancelablePromise<(DeployErc20Response | DeployErc20SignatureResponse)>;
    /**
     ...
     * @throws ApiError
     */
    static kcsDeployErc20Ledger(requestBody: (DeployErc20OffchainMnemonicAddress | DeployErc20OffchainMnemXpub | DeployErc20OffchainPKAddress | DeployErc20OffchainPKXpub | DeployErc20OffchainKMSAddress | DeployErc20OffchainKMSXpub)): CancelablePromise<(DeployErc20Response | DeployErc20SignatureResponse)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static storeCeloErc20Address(address: string, name: string): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static solTransfer(requestBody: (TransferSol | TransferSolKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static xlmTransfer(requestBody: (TransferXlm | TransferXlmKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static xlmAssetOffchain(requestBody: CreateXlmAsset): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static xrpTransfer(requestBody: (TransferXrp | TransferXrpKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static xrpAssetOffchain(requestBody: CreateXrpAsset): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static bnbTransfer(requestBody: (TransferBnb | TransferBnbKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static bnbAssetOffchain(requestBody: CreateBnbAsset): CancelablePromise<void>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static adaTransferOffchain(requestBody: (TransferAdaKeyPair | TransferAdaMnemonic | TransferAdaKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static tronTransferOffchain(requestBody: (TransferTron | TransferTronMnemonic | TransferTronKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static createTrc(requestBody: (TrcAddress | TrcXpub)): CancelablePromise<Trc20Response>;
    /**
     ...
     * @throws ApiError
     */
    static tronDeployTrc(requestBody: (DeployTrcOffchainMnemonicAddress | DeployTrcOffchainMnemXpub | DeployTrcOffchainPKAddress | DeployTrcOffchainPKXpub | DeployTrcOffchainKMSAddress | DeployTrcOffchainKMSXpub)): CancelablePromise<(DeployErc20Response | DeployErc20SignatureResponse)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static storeTrcAddress(address: string, name: string): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static egldTransfer(requestBody: (TransferEth | TransferEthMnemonic | TransferEthKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
    /**
     ...
     * @throws ApiError
     */
    static algoDeployErc20Ledger(requestBody: (DeployAlgoErc20OffchainMnemonicAddress | DeployAlgoErc20OffchainPKAddress | DeployAlgoErc20OffchainKMSAddress)): CancelablePromise<(DeployAlgoErc20Response | DeployAlgoErc20SignatureResponse)>;
    /**
     ...
     * @throws ApiError
     */
    static algoTransfer(requestBody: (TransferAlgo | TransferAlgoErc20 | TransferAlgoKMS)): CancelablePromise<(OffchainTransactionResult | OffchainTransactionSignatureResult)>;
}
