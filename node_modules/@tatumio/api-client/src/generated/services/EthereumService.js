...
class EthereumService {
     ...
     * @throws ApiError
     */
    static ethGenerateWallet(mnemonic, xTestnetType = 'ethereum-sepolia') {
     ...
     * @throws ApiError
     */
    static ethGenerateAddress(xpub, index, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGenerateAddressPrivateKey(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static ethWeb3Driver(xApiKey, requestBody, testnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static ethGetCurrentBlock(xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGetBlock(hash, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGetBalance(address, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGetTransaction(hash, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGetTransactionCount(address, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethGetTransactionByAddress(address, pageSize, offset, from, to, sort = 'DESC', xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethBlockchainTransfer(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static ethBlockchainSmartContractInvocation(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static ethGetInternalTransactionByAddress(address, pageSize, offset, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ethBroadcast(requestBody, xTestnetType = 'ethereum-sepolia') {
        return (0, request_1.request)({
            method: 'POST',
