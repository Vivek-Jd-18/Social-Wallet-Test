...
export declare class KeyManagementSystemService {
    /**
     ...
     * @throws ApiError
     */
    static getPendingTransactionsToSign(chain: 'BNB' | 'BTC' | 'ETH' | 'XLM' | 'XRP' | 'BCH' | 'LTC' | 'DOGE' | 'VET' | 'BSC' | 'MATIC' | 'CELO' | 'FLOW' | 'TRON' | 'ONE' | 'XDC' | 'EGLD' | 'KLAY' | 'SOL', signatures?: string): CancelablePromise<Array<PendingTransaction>>;
    /**
     * Get pending transactions to sign
     ...
     * @throws ApiError
     */
    static receivePendingTransactionsToSign(chain: 'BNB' | 'BTC' | 'ETH' | 'XLM' | 'XRP' | 'BCH' | 'LTC' | 'DOGE' | 'VET' | 'BSC' | 'MATIC' | 'CELO' | 'FLOW' | 'TRON' | 'ONE' | 'XDC' | 'EGLD' | 'KLAY' | 'SOL', requestBody?: KmsSignatureIds): CancelablePromise<Array<PendingTransaction>>;
    /**
     ...
     * @throws ApiError
     */
    static completePendingSignature(id: string, txId: string): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static getPendingTransactionToSign(id: string): CancelablePromise<PendingTransaction>;
    /**
     * Delete transaction
     ...
     * @throws ApiError
     */
    static deletePendingTransactionToSign(id: string, revert?: boolean): CancelablePromise<void>;
}
