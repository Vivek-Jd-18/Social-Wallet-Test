...
export declare class DataApiService {
     ...
     * @throws ApiError
     */
    static getCollections(chain: ChainEnum, collectionAddresses: string, tokenTypes?: 'nft' | 'multitoken', excludeMetadata?: ExcludeMetadata, pageSize?: PageSize, offset?: Offset): CancelablePromise<Array<{
        chain?: Chain;
        tokenId?: TokenId;
     ...
     * @throws ApiError
     */
    static getMetadata(chain: ChainEnum, tokenAddress: TokenAddress, tokenIds: string): CancelablePromise<Array<{
        chain?: Chain;
        tokenId?: TokenId;
        tokenAddress?: TokenAddress;
        tokenType?: TokenType;
     ...
     * @throws ApiError
     */
    static getBalances(chain: ChainEnum, addresses: string, tokenTypes?: 'nft' | 'multitoken' | 'fungible', excludeMetadata?: ExcludeMetadata, pageSize?: PageSize, offset?: Offset): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static getOwners(chain: ChainEnum, tokenAddress: TokenAddress, tokenId?: TokenId, pageSize?: PageSize, offset?: Offset): CancelablePromise<any[]>;
    /**
     ...
     * @throws ApiError
     */
    static getTransactions(chain: ChainEnum, addresses?: string, transactionTypes?: 'fungible,' | 'nft' | 'multitoken' | 'native' | 'internal', tokenAddress?: TokenAddress, tokenId?: TokenId, blockFrom?: BlockNumber, blockTo?: BlockNumber, pageSize?: PageSize, offset?: Offset): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static getTransactionsByHash(chain: ChainEnum, hash: string): CancelablePromise<any[]>;
    /**
     ...
     * @throws ApiError
     */
    static getEvents(chain: ChainEnum, contractAddresses: string, blockFrom: BlockNumber, blockTo: BlockNumber, eventType: 'tokenTransfer' | 'multitokenTransfer' | 'stablecoinTransfer' | 'uniswapTrade', signatures?: string, pageSize?: PageSize, offset?: Offset): CancelablePromise<any[]>;
    /**
     ...
     * @throws ApiError
     */
    static getBlocks(chain: ChainEnum, blockIds?: Array<number>, blockFrom?: BlockNumber, blockTo?: BlockNumber, timeFrom?: string, timeTo?: string, pageSize?: PageSize, offset?: Offset): CancelablePromise<any[]>;
    /**
     * Get latest block
     * <p><b>1 credit per API call</b></p>
     ...
     * @throws ApiError
     */
    static getLatestBlock(chain: ChainEnum): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static getTokens(chain: ChainEnum, tokenAddress: TokenAddress, tokenId?: TokenId): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static getUtxosByAddress(chain: ChainUtxoEnum, address: string, totalValue?: number): CancelablePromise<Array<{
        chain: ChainUtxoEnum;
        /**
         * Address of the UTXO
         */
