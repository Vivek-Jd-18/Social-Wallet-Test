...
export declare class FungibleTokensErc20OrCompatibleService {
    /**
     ...
     * @throws ApiError
     */
    static erc20Deploy(requestBody: (ChainDeployErc20 | ChainDeploySolanaSpl | ChainDeployCeloErc20 | ChainDeployKcsErc20 | ChainDeployAlgoErc20 | ChainDeployErc20KMS | ChainDeploySolanaSplKMS | ChainDeployCeloErc20KMS | ChainDeployKcsErc20KMS | ChainDeployAlgoErc20KMS), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static erc20Mint(requestBody: (ChainMintErc20 | ChainMintErc20KMS | ChainMintKcsErc20 | ChainMintKcsErc20KMS | ChainMintCeloErc20 | ChainMintCeloErc20KMS), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static erc20Burn(requestBody: (ChainBurnErc20 | ChainBurnErc20KMS | ChainBurnKcsErc20 | ChainBurnKcsErc20KMS | ChainBurnCeloErc20 | ChainBurnCeloErc20KMS | ChainBurnAlgoErc20 | ChainBurnAlgoErc20KMS), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static erc20Approve(requestBody: (ApproveErc20 | ApproveErc20KMS | ApproveCeloErc20 | ApproveCeloErc20KMS), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static erc20GetTransactionByAddress(chain: 'CELO' | 'ALGO' | 'MATIC' | 'ETH', address: string, tokenAddress: string, pageSize: number, offset?: number, from?: number, to?: number, sort?: 'ASC' | 'DESC'): CancelablePromise<Array<FungibleTx>>;
    /**
     ...
     * @throws ApiError
     */
    static erc20GetBalance(chain: 'CELO' | 'ALGO' | 'MATIC' | 'ETH' | 'BSC' | 'XDC' | 'KLAY' | 'ONE' | 'EGLD' | 'KCS' | 'SOL', address: string, contractAddress: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<Erc20Balance>;
    /**
     ...
     * @throws ApiError
     */
    static erc20GetBalanceAddress(chain: 'CELO' | 'ETH' | 'MATIC' | 'SOL' | 'ALGO', address: string): CancelablePromise<Array<Erc20BalanceForAddress>>;
}
