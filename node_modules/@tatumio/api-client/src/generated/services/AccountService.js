...
class AccountService {
     ...
     * @throws ApiError
     */
    static createAccount(requestBody) {
     ...
     * @throws ApiError
     */
    static getAccounts(pageSize, page, sort, sortBy, active, onlyNonZeroBalance, frozen, currency, accountNumber) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/ledger/account`,
            query: {
     ...
     * @throws ApiError
     */
    static getAccountsCount(pageSize, page, sort, sortBy, active, onlyNonZeroBalance, frozen, currency, accountNumber) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static createAccountBatch(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static getAccountsByCustomerId(pageSize, id, offset, accountCode) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static getAccountByAccountId(id) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static updateAccountByAccountId(id, requestBody) {
        return (0, request_1.request)({
            method: 'PUT',
            path: `/v3/ledger/account/${id}`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static blockAmount(id, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static unblockAmountWithTransaction(id, requestBody) {
        return (0, request_1.request)({
            method: 'PUT',
            path: `/v3/ledger/account/block/${id}`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static getBlockAmount(id, pageSize, offset) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/ledger/account/block/${id}`,
            query: {
     ...
     * @throws ApiError
     */
    static deleteAllBlockAmount(id) {
        return (0, request_1.request)({
            method: 'DELETE',
