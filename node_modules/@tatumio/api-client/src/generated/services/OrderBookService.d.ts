...
export declare class OrderBookService {
         ...
         * "attr": {
             ...
             * {
                 ...
                 * "attr": {
                     ...
                     * @throws ApiError
                     */
    static storeTrade(requestBody: (CreateTrade | CreateFutureTrade)): CancelablePromise<Id>;
    /**
     ...
     * @throws ApiError
     */
    static chartRequest(requestBody: ChartRequest): CancelablePromise<Array<Chart>>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static getHistoricalTrades(pageSize: number, id?: string, pair?: string, offset?: number, count?: boolean, types?: Array<'FUTURE_BUY' | 'FUTURE_SELL' | 'BUY' | 'SELL'>): CancelablePromise<Array<Trade>>;
    /**
     * List all historical trades
     * <h4>1 credit per API call.</h4><br/><p>List all historical trades. It is possible to list all trades, trades for specific trading pair and/or account.</p>
     * @param requestBody
     ...
     * @throws ApiError
     */
    static getHistoricalTradesBody(requestBody?: ListOderBookHistoryBody): CancelablePromise<Array<Trade>>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static getBuyTrades(pageSize: number, id?: string, customerId?: string, offset?: number, pair?: string, count?: boolean, tradeType?: 'FUTURE_BUY' | 'BUY'): CancelablePromise<Array<Trade>>;
    /**
     * List all active buy trades
     * <h4>1 credit per API call.</h4><br/><p>List all active buy trades.</p>
     * @param requestBody
     ...
     * @throws ApiError
     */
    static getBuyTradesBody(requestBody: ListOderBookActiveBuyBody): CancelablePromise<Array<Trade>>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static getSellTrades(pageSize: number, id?: string, customerId?: string, offset?: number, pair?: string, count?: boolean, tradeType?: 'FUTURE_SELL' | 'SELL'): CancelablePromise<Array<Trade>>;
    /**
     * List all active sell trades
     * <h4>1 credit per API call.</h4><br/><p>List all active sell trades.</p>
     * @param requestBody
     ...
     * @throws ApiError
     */
    static getSellTradesBody(requestBody: ListOderBookActiveSellBody): CancelablePromise<Array<Trade>>;
    /**
     ...
     * @throws ApiError
     */
    static getTradeById(id: string): CancelablePromise<Trade>;
    /**
     ...
     * @throws ApiError
     */
    static deleteTrade(id: string): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static deleteAccountTrades(id: string): CancelablePromise<void>;
}
