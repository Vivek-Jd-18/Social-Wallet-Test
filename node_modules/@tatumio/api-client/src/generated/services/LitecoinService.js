...
class LitecoinService {
     ...
     * @throws ApiError
     */
    static ltcGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static ltcGetRawTransaction(hash) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ltcGetTxByAddress(address, pageSize, offset, txType) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/litecoin/transaction/address/${address}`,
            query: Object.assign({ 'pageSize': pageSize, 'offset': offset }, (txType && { txType })),
            errors: {
                400: `Bad Request. Validation failed for the given object in the HTTP Body or Request parameters.`,
                401: `Unauthorized. Not valid or inactive subscription key present in the HTTP Header.`,
                403: `Forbidden. The request is authenticated, but it is not possible to required perform operation due to logical error or invalid permissions.`,
     ...
     * @throws ApiError
     */
    static ltcGetBalanceOfAddress(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ltcGetBalanceOfAddressBatch(addresses) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ltcGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static ltcGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static ltcTransferBlockchain(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static ltcBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
