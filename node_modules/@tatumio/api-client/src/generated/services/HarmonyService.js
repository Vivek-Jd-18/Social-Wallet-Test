...
class HarmonyService {
     ...
     * @throws ApiError
     */
    static oneGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static oneGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static oneFormatAddress(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static oneGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static oneWeb3Driver(xApiKey, requestBody, shardId) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static oneGetBlock(hash, shardId) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static oneGetBalance(address, shardId) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static oneGetTransaction(hash, shardId) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static oneGetTransactionCount(address, shardId) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static oneBlockchainTransfer(requestBody, shardId) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static oneBlockchainSmartContractInvocation(requestBody, shardId) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static oneBroadcast(requestBody, shardId) {
        return (0, request_1.request)({
            method: 'POST',
...
//# sourceMappingURL=HarmonyService.js.map