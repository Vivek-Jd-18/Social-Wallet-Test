...
class NodeRpcService {
         ...
         * [
             * {
                 ...
                 * {
                     ...
                     * @throws ApiError
                     */
    static nodeJsonPostRpcDriver(chain, requestBody, xApiKey, rpcPath) {
         ...
         * [
             * {
                 ...
                 * {
                     ...
                     * @throws ApiError
                     */
    static nodeJsonRpcPutDriver(chain, requestBody, xApiKey, rpcPath) {
        return (0, request_1.request)({
            method: 'PUT',
            path: `/v3/blockchain/node/${chain}/${xApiKey}/${rpcPath}`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static nodeJsonRpcGetDriver(chain, xApiKey, rpcPath) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/blockchain/node/${chain}/${xApiKey}/${rpcPath}`,
            errors: {
...
exports.NodeRpcService = NodeRpcService;
//# sourceMappingURL=NodeRpcService.js.map