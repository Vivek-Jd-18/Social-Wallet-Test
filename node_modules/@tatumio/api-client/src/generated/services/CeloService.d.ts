...
export declare class CeloService {
    /**
     ...
     * @throws ApiError
     */
    static celoGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static celoGenerateAddress(xpub: string, index: number): CancelablePromise<{
        /**
         * Celo address
         */
        address?: string;
     ...
     * @throws ApiError
     */
    static celoGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static celoWeb3Driver(xApiKey: string, requestBody: any): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static celoGetCurrentBlock(): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static celoGetBlock(hash: string): CancelablePromise<CeloBlock>;
    /**
     ...
     * @throws ApiError
     */
    static celoGetBalance(address: string): CancelablePromise<{
        /**
         * Balance of Celo
         */
        celo?: string;
     ...
     * @throws ApiError
     */
    static celoGetTransactionByAddress(address: string, pageSize: number, offset?: number, from?: number, to?: number, sort?: 'ASC' | 'DESC'): CancelablePromise<Array<CeloTx>>;
    /**
     ...
     * @throws ApiError
     */
    static celoGetTransaction(hash: string): CancelablePromise<CeloTx>;
    /**
     ...
     * @throws ApiError
     */
    static celoGetTransactionCount(address: string): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static celoBlockchainTransfer(requestBody: (TransferCeloBlockchain | TransferCeloBlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static celoBlockchainSmartContractInvocation(requestBody: (CallCeloReadSmartContractMethod | CallCeloSmartContractMethod | CallCeloSmartContractMethodKMS)): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static celoBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
