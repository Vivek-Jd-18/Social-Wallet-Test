...
export declare class DogecoinService {
    /**
     ...
     * @throws ApiError
     */
    static dogeGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static dogeGenerateAddress(xpub: string, index: number): CancelablePromise<{
        /**
         * Dogecoin address
         */
        address?: string;
     ...
     * @throws ApiError
     */
    static dogeGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static dogeRpcDriver(requestBody: {
        /**
     ...
     * @throws ApiError
     */
    static dogeGetBlockChainInfo(): CancelablePromise<DogeInfo>;
    /**
     ...
     * @throws ApiError
     */
    static dogeGetBlockHash(i: number): CancelablePromise<{
        /**
         * Block hash
         */
        hash?: string;
     ...
     * @throws ApiError
     */
    static dogeGetBlock(hash: string): CancelablePromise<DogeBlock>;
    /**
     ...
     * @throws ApiError
     */
    static dogeGetRawTransaction(hash: string): CancelablePromise<DogeTx>;
    /**
     ...
     * @throws ApiError
     */
    static dogeGetTxByAddress(address: string, pageSize: number, offset?: number, txType?: 'incoming' | 'outgoing'): CancelablePromise<Array<DogeTxByAddress>>;
    /**
     ...
     * @throws ApiError
     */
    static dogeGetBalanceOfAddress(address: string): CancelablePromise<BtcBasedBalance>;
    /**
     ...
     * @throws ApiError
     */
    static dogeGetBalanceOfAddressBatch(addresses: string): CancelablePromise<Array<BtcBasedBalance>>;
    /**
     ...
     * @throws ApiError
     */
    static dogeGetMempool(): CancelablePromise<Array<string>>;
    /**
     ...
     * @throws ApiError
     */
    static dogeGetUtxo(hash: string, index: number): CancelablePromise<DogeUTXO>;
    /**
     ...
     * @throws ApiError
     */
    static dogeTransferBlockchain(requestBody: (DogeTransactionAddress | DogeTransactionAddressKMS | DogeTransactionUTXO | DogeTransactionUTXOKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static dogeBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
