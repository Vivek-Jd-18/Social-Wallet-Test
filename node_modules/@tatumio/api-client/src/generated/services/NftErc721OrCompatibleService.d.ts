...
export declare class NftErc721OrCompatibleService {
    /**
     ...
     * @throws ApiError
     */
    static nftDeployErc721(requestBody: (DeployNft | DeployNftCelo | DeployNftTron | DeployNftKMS | DeployNftCeloKMS | DeployNftTronKMS | DeployNftFlowPK | DeployNftFlowMnemonic), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static nftAddMinter(requestBody: (AddNftMinter | AddNftMinterKMS), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * Mint an NFT
     * <p><b>100 credits per API call on Flow<br/>
     * 2 credits per API call on the other blockchains</b></p>
     ...
     * {
         ...
         * {
             ...
             * @throws ApiError
             */
    static nftMintErc721(requestBody: (MintNftExpress | MintNftExpressAlgorand | MintNftExpressSolana | MintNftMinter | MintNft | MintNftKMS | MintNftAlgorand | MintNftAlgorandKMS | MintNftCelo | MintNftKMSCelo | MintNftFlowPK | MintNftFlowMnemonic | MintNftFlowKMS | MintNftSolana | MintNftSolanaKMS | MintNftTron | MintNftKMSTron), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | FlowMintedResult | SolanaMintedResult | AlgorandMintedResult | SignatureId)>;
    /**
     * Transfer an NFT
     * <p><b>100 credits per API call on Flow<br/>
     * 2 credits per API call on the other blockchains</b></p>
     ...
     * @throws ApiError
     */
    static nftTransferErc721(requestBody: (TransferNft | TransferNftCelo | TransferNftTron | TransferNftSolana | TransferNftAlgo | TransferNftAlgoExpress | TransferNftFlowPK | TransferNftFlowMnemonic | TransferNftKMS | TransferNftKMSCelo | TransferNftAlgoKMS | TransferNftSolanaKMS | TransferNftFlowKMS | TransferNftKMSTron), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * Mint multiple NFTs
     * <p><b>100 credits per API call on Flow<br/>
     * 2 credits per API call on the other blockchains</b></p>
     ...
     * @throws ApiError
     */
    static nftBurnErc721(requestBody: (BurnNft | BurnNftCelo | BurnNftAlgo | BurnNftKMSCelo | BurnNftTron | BurnNftSolana | BurnNftSolanaKMS | BurnNftKMSTron | BurnNftKMS | BurnNftAlgoKMS | BurnNftFlowPK | BurnNftFlowMnemonic | BurnNftFlowKMS), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static nftVerifyInCollection(requestBody: (VerifySolanaNFT | VerifySolanaNFTKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static nftGetTransactionByAddress(chain: 'CELO' | 'ETH' | 'MATIC', address: string, tokenAddress: string, pageSize: number, offset?: number, from?: number, to?: number): CancelablePromise<Array<NftTx>>;
    /**
     ...
     * @throws ApiError
     */
    static nftGetTransactionByToken(chain: 'CELO' | 'ETH' | 'MATIC', tokenId: string, tokenAddress: string, pageSize: number, offset?: number, from?: number, to?: number): CancelablePromise<Array<NftTx>>;
    /**
     ...
     * @throws ApiError
     */
    static nftGetTransactErc721(chain: 'ETH' | 'MATIC' | 'KCS' | 'ONE' | 'KLAY' | 'CELO' | 'TRON' | 'FLOW' | 'BSC', hash: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(CeloTx | EthTx | FlowTx)>;
    /**
     ...
     * @throws ApiError
     */
    static nftGetTokensByAddressErc721(chain: 'ALGO' | 'BSC' | 'CELO' | 'ETH' | 'MATIC' | 'SOL', address: string): CancelablePromise<Array<NftTokenByAddressErc721>>;
    /**
     ...
     * @throws ApiError
     */
    static nftGetTokensByCollectionErc721(chain: 'CELO' | 'MATIC' | 'ETH', pageSize: number, address: string, offset?: number): CancelablePromise<Array<NftTokenByCollectionErc721>>;
    /**
     ...
     * @throws ApiError
     */
    static nftGetBalanceErc721(chain: 'ETH' | 'MATIC' | 'KCS' | 'ONE' | 'KLAY' | 'CELO' | 'TRON' | 'FLOW' | 'BSC' | 'SOL' | 'ALGO' | 'EGLD', address: string, contractAddress: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(NftGetBalanceScAlgo | NftGetBalanceSc)>;
    /**
     * Get NFT metadata
     * <p><b>1 credit per API call</b></p>
     ...
     * @throws ApiError
     */
    static nftGetMetadataErc721(chain: 'BSC' | 'CELO' | 'ETH' | 'FLOW' | 'KCS' | 'KLAY' | 'MATIC' | 'ONE' | 'SOL' | 'TRON' | 'ALGO', contractAddress: string, tokenId: string, account?: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(NftMetadataErc721 | NftMetadataErc721OnchainSolana | NftMetadataErc721OnchainFlow | NftMetadataErc721OnchainAlgo)>;
    /**
     ...
     * @throws ApiError
     */
    static nftGetProvenanceDataErc721(chain: 'BSC' | 'CELO' | 'ETH' | 'KCS' | 'KLAY' | 'MATIC' | 'ONE', contractAddress: string, tokenId: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<Array<NftProvenanceDataErc721>>;
    /**
     ...
     * @throws ApiError
     */
    static nftGetRoyaltyErc721(chain: 'BSC' | 'CELO' | 'ETH' | 'KCS' | 'KLAY' | 'MATIC' | 'ONE' | 'SOL' | 'TRON', contractAddress: string, tokenId: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<NftRoyaltyErc721>;
    /**
     ...
     * @throws ApiError
     */
    static nftUpdateCashbackErc721(requestBody: (UpdateCashbackValueForAuthorNft | UpdateCashbackValueForAuthorNftCelo | UpdateCashbackValueForAuthorNftTron | UpdateCashbackValueForAuthorNftKMS | UpdateCashbackValueForAuthorNftKMSCelo | UpdateCashbackValueForAuthorNftKMSTron), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * @deprecated
     ...
     * @throws ApiError
     */
    static nftGetContractAddress(chain: 'ALGO' | 'ETH' | 'ONE' | 'KLAY' | 'CELO' | 'TRON' | 'FLOW' | 'MATIC' | 'KCS' | 'BSC', hash: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<{
        /**
