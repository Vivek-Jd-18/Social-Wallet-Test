...
export declare class EthereumService {
     ...
     * @throws ApiError
     */
    static ethGenerateWallet(mnemonic?: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static ethGenerateAddress(xpub: string, index: number, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<GeneratedAddressEth>;
    /**
     ...
     * @throws ApiError
     */
    static ethGenerateAddressPrivateKey(requestBody: PrivKeyRequest, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static ethWeb3Driver(xApiKey: string, requestBody: any, testnetType?: 'ethereum-sepolia'): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetCurrentBlock(xTestnetType?: 'ethereum-sepolia'): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetBlock(hash: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<EthBlock>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetBalance(address: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<EthBalance>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetTransaction(hash: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<EthTx>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetTransactionCount(address: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetTransactionByAddress(address: string, pageSize: number, offset?: number, from?: number, to?: number, sort?: 'ASC' | 'DESC', xTestnetType?: 'ethereum-sepolia'): CancelablePromise<Array<EthTx>>;
    /**
     ...
     * @throws ApiError
     */
    static ethBlockchainTransfer(requestBody: (TransferEthBlockchain | TransferEthBlockchainKMS), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static ethBlockchainSmartContractInvocation(requestBody: (CallSmartContractMethod | CallReadSmartContractMethod | CallEthSmartContractMethodCaller | CallSmartContractMethodKMS), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static ethGetInternalTransactionByAddress(address: string, pageSize: number, offset?: number, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<Array<EthTxInternal>>;
    /**
     ...
     * @throws ApiError
     */
    static ethBroadcast(requestBody: BroadcastKMS, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<TransactionHash>;
}
