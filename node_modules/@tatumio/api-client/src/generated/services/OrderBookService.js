...
class OrderBookService {
     ...
     * @throws ApiError
     */
    static chartRequest(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/trade/chart`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static getHistoricalTrades(pageSize, id, pair, offset, count, types) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static getHistoricalTradesBody(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/trade/history`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static getBuyTrades(pageSize, id, customerId, offset, pair, count, tradeType) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/trade/buy`,
            query: {
     ...
     * @throws ApiError
     */
    static getBuyTradesBody(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/trade/buy`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static getSellTrades(pageSize, id, customerId, offset, pair, count, tradeType) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/trade/sell`,
            query: {
     ...
     * @throws ApiError
     */
    static getSellTradesBody(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
            path: `/v3/trade/sell`,
            body: requestBody,
     ...
     * @throws ApiError
     */
    static getMatchedTrades(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
