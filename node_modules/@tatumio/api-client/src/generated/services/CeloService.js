...
class CeloService {
     ...
     * @throws ApiError
     */
    static celoGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static celoGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static celoGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static celoWeb3Driver(xApiKey, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static celoGetTransactionByAddress(address, pageSize, offset, from, to, sort = 'DESC') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static celoGetTransaction(hash) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static celoGetTransactionCount(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static celoBlockchainTransfer(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static celoBlockchainSmartContractInvocation(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static celoBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
...
//# sourceMappingURL=CeloService.js.map