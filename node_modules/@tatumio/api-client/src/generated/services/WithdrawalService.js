...
class WithdrawalService {
     ...
     * @throws ApiError
     */
    static storeWithdrawal(requestBody) {
     ...
     * @throws ApiError
     */
    static getWithdrawals(pageSize, currency, status, offset) {
        return (0, request_1.request)({
            method: 'GET',
            path: `/v3/offchain/withdrawal`,
            query: {
     ...
     * @throws ApiError
     */
    static completeWithdrawal(id, txId) {
        return (0, request_1.request)({
            method: 'PUT',
     ...
     * @throws ApiError
     */
    static cancelInProgressWithdrawal(id, revert = true) {
        return (0, request_1.request)({
            method: 'DELETE',
     ...
     * @throws ApiError
     */
    static broadcastBlockchainTransaction(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
