...
exports.BnbSmartChainService = void 0;
const request_1 = require("../core/request");
class BnbSmartChainService {
    /**
     * Generate BSC wallet
     ...
     * @throws ApiError
     */
    static bscGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static bscGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static bscGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static bscWeb3Driver(xApiKey, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static bscGetTransactionCount(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static bscBlockchainTransfer(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static bscBlockchainSmartContractInvocation(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static bscBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
...
exports.BnbSmartChainService = BnbSmartChainService;
//# sourceMappingURL=BnbSmartChainService.js.map