...
export declare class BlockchainFeesService {
    /**
     ...
     * @throws ApiError
     */
    static getBlockchainFee(chain: 'ETH' | 'BTC' | 'LTC' | 'DOGE'): CancelablePromise<BlockchainFee>;
    /**
     ...
     * @throws ApiError
     */
    static estimateFeeBlockchain(requestBody: (EstimateFee | EstimateFeeBatchMintNft | EstimateFeeDeployCustodialWallet | EstimateFeeTransferFromCustodial | EstimateFeeFromAddress | EstimateFeeFromUTXO)): CancelablePromise<(FeeBtcBased | FeeEvmBased)>;
    /**
     ...
     * @throws ApiError
     */
    static bscEstimateGas(requestBody: BscEstimateGas): CancelablePromise<GasEstimated>;
    /**
     ...
     * @throws ApiError
     */
    static celoEstimateGas(requestBody: CeloEstimateGas): CancelablePromise<GasEstimated>;
    /**
     ...
     * @throws ApiError
     */
    static egldEstimateGas(requestBody: TransactionFeeEgldBlockchain): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static ethEstimateGas(requestBody: EthEstimateGas, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<EthGasEstimation>;
    /**
     ...
     * @throws ApiError
     */
    static ethEstimateGasBatch(requestBody: EthEstimateGasArray, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<EthGasEstimationBatch>;
    /**
     ...
     * @throws ApiError
     */
    static oneEstimateGas(requestBody: OneEstimateGas): CancelablePromise<{
        /**
         * The number of the gas units needed to process the transaction at the estimated gas price
         */
        gasLimit: string;
     ...
     * @throws ApiError
     */
    static klaytnEstimateGas(requestBody: KlaytnEstimateGas): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static kcsEstimateGas(requestBody: KcsEstimateGas): CancelablePromise<GasEstimated>;
    /**
     ...
     * @throws ApiError
     */
    static polygonEstimateGas(requestBody: PolygonEstimateGas): CancelablePromise<GasEstimated>;
    /**
     ...
     * @throws ApiError
     */
    static xdcEstimateGas(requestBody: XdcEstimateGas): CancelablePromise<GasEstimated>;
    /**
     ...
     * @throws ApiError
     */
    static vetEstimateGas(requestBody: VetEstimateGas): CancelablePromise<number>;
}
