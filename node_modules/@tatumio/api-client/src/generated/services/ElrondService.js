...
class ElrondService {
     ...
     * @throws ApiError
     */
    static egldGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static egldGenerateAddress(mnemonic, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static egldGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static egldNodePost(xApiKey, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static egldGetTransaction(hash) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static egldGetTransactionAddress(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static egldGetTransactionCount(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static egldBlockchainTransfer(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static egldBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
...
exports.ElrondService = ElrondService;
//# sourceMappingURL=ElrondService.js.map