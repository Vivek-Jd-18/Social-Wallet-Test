...
exports.CustodialManagedWalletsService = void 0;
const request_1 = require("../core/request");
class CustodialManagedWalletsService {
    /**
     ...
     * @throws ApiError
     */
    static custodialGetWallet(id, _export = false) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static custodialDeleteWallet(id) {
        return (0, request_1.request)({
            method: 'DELETE',
            path: `/v3/custodial/wallet/${id}`,
            errors: {
                 ...
                 * "walletIds": [
                     * {
                         ...
                         * {
                             ...
                             * @throws ApiError
                             */
    static custodialTransferManagedAddress(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
...
exports.CustodialManagedWalletsService = CustodialManagedWalletsService;
//# sourceMappingURL=CustodialManagedWalletsService.js.map