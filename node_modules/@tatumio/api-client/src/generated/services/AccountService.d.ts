...
export declare class AccountService {
     ...
     * @throws ApiError
     */
    static createAccount(requestBody: (CreateAccountXpub | CreateAccount)): CancelablePromise<Account>;
    /**
     * List all accounts
     ...
     * @throws ApiError
     */
    static getAccounts(pageSize?: number, page?: number, sort?: 'asc' | 'desc', sortBy?: 'id' | 'account_number' | 'account_balance' | 'available_balance', active?: boolean, onlyNonZeroBalance?: boolean, frozen?: boolean, currency?: string, accountNumber?: string): CancelablePromise<Array<Account>>;
    /**
     ...
     * @throws ApiError
     */
    static getAccountsCount(pageSize?: number, page?: number, sort?: 'asc' | 'desc', sortBy?: '_id' | 'account_number' | 'account_balance' | 'available_balance', active?: boolean, onlyNonZeroBalance?: boolean, frozen?: boolean, currency?: string, accountNumber?: string): CancelablePromise<EntitiesCount>;
    /**
     ...
     * @throws ApiError
     */
    static createAccountBatch(requestBody: CreateAccountBatch): CancelablePromise<Array<Account>>;
    /**
     ...
     * @throws ApiError
     */
    static getAccountsByCustomerId(pageSize: number, id: string, offset?: number, accountCode?: string): CancelablePromise<Array<Account>>;
    /**
     * Get account by ID
     ...
     * @throws ApiError
     */
    static getAccountByAccountId(id: string): CancelablePromise<Account>;
    /**
     * Update account
     ...
     * @throws ApiError
     */
    static updateAccountByAccountId(id: string, requestBody: UpdateAccount): CancelablePromise<void>;
    /**
     * Get account balance
     ...
     * @throws ApiError
     */
    static getAccountBalance(id: string): CancelablePromise<AccountBalance>;
    /**
     ...
     * @throws ApiError
     */
    static blockAmount(id: string, requestBody: BlockAmount): CancelablePromise<Id>;
    /**
     ...
     * @throws ApiError
     */
    static unblockAmountWithTransaction(id: string, requestBody: UnblockAmount): CancelablePromise<TransactionResult>;
    /**
     ...
     * @throws ApiError
     */
    static deleteBlockAmount(id: string): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static getBlockAmount(id: string, pageSize: number, offset?: number): CancelablePromise<Array<Blockage>>;
    /**
     ...
     * @throws ApiError
     */
    static getBlockAmountById(id: string): CancelablePromise<Blockage>;
    /**
     ...
     * @throws ApiError
     */
    static deleteAllBlockAmount(id: string): CancelablePromise<void>;
    /**
     * Activate account
     ...
     * @throws ApiError
     */
    static activateAccount(id: string): CancelablePromise<void>;
    /**
     * Deactivate account
     ...
     * @throws ApiError
     */
    static deactivateAccount(id: string): CancelablePromise<void>;
    /**
     * Freeze account
     ...
     * @throws ApiError
     */
    static freezeAccount(id: string): CancelablePromise<void>;
    /**
     * Unfreeze account
     ...
     * @throws ApiError
     */
    static unfreezeAccount(id: string): CancelablePromise<void>;
}
