...
export declare class MultiTokensErc1155OrCompatibleService {
    /**
     ...
     * @throws ApiError
     */
    static deployMultiToken(requestBody: (DeployMultiToken | DeployMultiTokenKMS | DeployMultiTokenCelo | DeployMultiTokenCeloKMS), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * Mint a Multi Token
     * <p><b>2 credits per API call</b></p>
     ...
     * @throws ApiError
     */
    static mintMultiToken(requestBody: (MintMultiToken | MintMultiTokenKMS | MintMultiTokenCelo | MintMultiTokenKMSCelo), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static mintMultiTokenBatch(requestBody: (MintMultiTokenBatch | MintMultiTokenBatchKMS | MintMultiTokenBatchCelo | MintMultiTokenBatchKMSCelo), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     * Burn a Multi Token
     * <p><b>2 credits per API call</b></p>
     ...
     * @throws ApiError
     */
    static burnMultiToken(requestBody: (BurnMultiToken | BurnMultiTokenKMS | BurnMultiTokenCelo | BurnMultiTokenKMSCelo), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static burnMultiTokenBatch(requestBody: (BurnMultiTokenBatch | BurnMultiTokenBatchKMS | BurnMultiTokenBatchCelo | BurnMultiTokenBatchKMSCelo), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static transferMultiToken(requestBody: (TransferMultiToken | TransferMultiTokenCelo | TransferMultiTokenKMS | TransferMultiTokenKMSCelo), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static transferMultiTokenBatch(requestBody: (TransferMultiTokenBatch | TransferMultiTokenBatchKMS | TransferMultiTokenBatchCelo | TransferMultiTokenBatchKMSCelo), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static addMultiTokenMinter(requestBody: (AddMultiTokenMinter | AddMultiTokenMinterKMS), xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static multiTokenGetTransactionByAddress(chain: 'CELO' | 'ETH' | 'MATIC', address: string, tokenAddress: string, pageSize: number, offset?: number, from?: number, to?: number): CancelablePromise<Array<MultiTx>>;
    /**
     ...
     * @throws ApiError
     */
    static multiTokenGetTransaction(chain: 'ETH' | 'MATIC' | 'KCS' | 'KLAY' | 'ONE' | 'CELO' | 'BSC', hash: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<(CeloTx | EthTx)>;
    /**
     ...
     * @throws ApiError
     */
    static multiTokenGetAddressBalance(chain: 'ETH' | 'MATIC' | 'CELO', address: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<Array<{
        /**
     ...
     * @throws ApiError
     */
    static multiTokenGetBalance(chain: 'ETH' | 'MATIC' | 'KCS' | 'KLAY' | 'ONE' | 'CELO' | 'BSC', address: string, contractAddress: string, tokenId: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static multiTokenGetBalanceBatch(chain: 'ETH' | 'MATIC' | 'KCS' | 'KLAY' | 'ONE' | 'CELO' | 'BSC', contractAddress: string, tokenId: string, address: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<Array<string>>;
    /**
     ...
     * @throws ApiError
     */
    static multiTokenGetMetadata(chain: 'ETH' | 'MATIC' | 'KCS' | 'KLAY' | 'ONE' | 'CELO' | 'BSC', token: string, contractAddress: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<{
        /**
     ...
     * @throws ApiError
     */
    static multiTokenGetContractAddress(chain: 'ETH' | 'MATIC' | 'KCS' | 'KLAY' | 'ONE' | 'CELO' | 'BSC', hash: string, xTestnetType?: 'ethereum-sepolia'): CancelablePromise<{
        /**
