...
export declare class NotificationSubscriptionsService {
    /**
     ...
     * @throws ApiError
     */
    static getSubscriptions(pageSize: number, offset?: number, address?: string): CancelablePromise<Array<Subscription>>;
    /**
     ...
     * @throws ApiError
     */
    static enableWebHookHmac(requestBody: HmacWebHook): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static disableWebHookHmac(): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static getSubscriptionsCount(pageSize: number, offset?: number, address?: string): CancelablePromise<EntitiesCount>;
    /**
     ...
     * @throws ApiError
     */
    static deleteSubscription(id: string): CancelablePromise<void>;
    /**
     ...
     * @throws ApiError
     */
    static getSubscriptionReport(id: string): CancelablePromise<(Array<Account> | Array<Transaction>)>;
    /**
     ...
     * @throws ApiError
     */
    static getAllWebhooks(pageSize: number, offset?: number, direction?: 'asc' | 'desc', failed?: boolean): CancelablePromise<Array<WebHook>>;
    /**
     ...
     * @throws ApiError
     */
    static getAllWebhooksCount(pageSize: number, offset?: number, direction?: 'asc' | 'desc', failed?: boolean): CancelablePromise<EntitiesCount>;
}
