...
export declare class KuCoinService {
     ...
     * @throws ApiError
     */
    static kcsGenerateWallet(mnemonic?: string): CancelablePromise<Wallet>;
    /**
     ...
     * @throws ApiError
     */
    static kcsGenerateAddress(xpub: string, index: number): CancelablePromise<{
        /**
         * Kcs address
         */
        address?: string;
     ...
     * @throws ApiError
     */
    static kcsGenerateAddressPrivateKey(requestBody: PrivKeyRequest): CancelablePromise<PrivKey>;
    /**
     * @deprecated
     * Web3 HTTP driver
     ...
     * @throws ApiError
     */
    static kcsWeb3Driver(xApiKey: string, requestBody: any): CancelablePromise<any>;
    /**
     ...
     * @throws ApiError
     */
    static kcsGetCurrentBlock(): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static kcsGetBlock(hash: string): CancelablePromise<EthBlock>;
    /**
     ...
     * @throws ApiError
     */
    static kcsGetBalance(address: string): CancelablePromise<{
        /**
         * Balance in KCS
         */
        balance?: string;
     ...
     * @throws ApiError
     */
    static kcsGetTransaction(hash: string): CancelablePromise<KcsTx>;
    /**
     ...
     * @throws ApiError
     */
    static kcsGetTransactionCount(address: string): CancelablePromise<number>;
    /**
     ...
     * @throws ApiError
     */
    static kcsBlockchainTransfer(requestBody: (TransferKcsBlockchain | TransferKcsBlockchainKMS)): CancelablePromise<(TransactionHash | SignatureId)>;
    /**
     ...
     * @throws ApiError
     */
    static kcsBlockchainSmartContractInvocation(requestBody: (CallKcsSmartContractReadMethod | CallKcsSmartContractMethod | CallKcsSmartContractMethodKMS)): CancelablePromise<(TransactionHash | SignatureId | Data)>;
    /**
     ...
     * @throws ApiError
     */
    static kcsBroadcast(requestBody: BroadcastKMS): CancelablePromise<TransactionHash>;
}
