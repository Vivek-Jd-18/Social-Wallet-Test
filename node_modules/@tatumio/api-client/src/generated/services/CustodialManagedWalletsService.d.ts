...
export declare class CustodialManagedWalletsService {
    /**
     ...
     * @throws ApiError
     */
    static custodialCreateWallet(requestBody?: {
     ...
     * @throws ApiError
     */
    static custodialGetWallets(): CancelablePromise<Array<CustodialManagedAddress>>;
    /**
     * Get managed address
     * <h4>1 credit per API call.</h4><br/>
     ...
     * @throws ApiError
     */
    static custodialGetWallet(id: string, _export?: boolean): CancelablePromise<Array<CustodialManagedAddress>>;
    /**
     ...
     * @throws ApiError
     */
    static custodialDeleteWallet(id: string): CancelablePromise<void>;
    /**
                 ...
                 * "walletIds": [
                     * {
                         ...
                         * {
                             ...
                             * @throws ApiError
                             */
    static custodialTransferManagedAddress(requestBody?: TransferManagedAddress): CancelablePromise<TransactionHash>;
}
