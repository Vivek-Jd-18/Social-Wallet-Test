...
class PolygonService {
     ...
     * @throws ApiError
     */
    static polygonGenerateWallet(mnemonic) {
     ...
     * @throws ApiError
     */
    static polygonGenerateAddress(xpub, index) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static polygonGenerateAddressPrivateKey(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static polygonWeb3Driver(xApiKey, requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static polygonGetBalance(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static polygonGetTransaction(hash) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static polygonGetTransactionByAddress(address, pageSize, offset, from, to, sort = 'DESC') {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static polygonGetTransactionCount(address) {
        return (0, request_1.request)({
            method: 'GET',
     ...
     * @throws ApiError
     */
    static polygonBlockchainTransfer(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static polygonBlockchainSmartContractInvocation(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
     ...
     * @throws ApiError
     */
    static polygonBroadcast(requestBody) {
        return (0, request_1.request)({
            method: 'POST',
